    ...
    public:
        ...
        vector<Board> getNonWinners() {
            ...
            for (it = boards.begin(); it != boards.end(); it++){
                if (!(*it).winner()) { nonWinners.push_back((*it)); }
            }
            return nonWinners;
        }
        ...
        void findFirstWinner(){
            ...
            for (it = numbers.begin(); it != numbers.end(); it++){
                callNumber((*it));
                if ( (itWinner = getWinner()) != boards.end() ) { break; }
            }
        ...
        void findLastWinner(){
            ...
            for (it = numbers.begin(); it != numbers.end(); it++){
                ...
                if ( getNonWinners().size() == 1 ) { last = getNonWinners()[0]; }
                if ( getNonWinners().size() < 1 ) { break; }
            }
...
int main() {
    Bingo myBingo("../2021/4/input.txt");
    // myBingo.printBoards();
